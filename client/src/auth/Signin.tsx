...
<div className='flex justify-center'>
          <button type="submit" className="w-full text-white bg-black hover:bg-black focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm w-full  px-5 py-2.5 text-center cursor-pointer">Sign In</button>
          </div>
        </form>
      </div>
    </div>
