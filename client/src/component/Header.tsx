  ...
  return (
    <>
      <section className=" border-b-1 border-slate-100">
        <div className="relative max-w-8xl mx-8 px-3 sm:px-8 py-4 align-bottom">
          <div className="inline-block align-bottom">
            <a
              className="inline-block text-3xl sm:text-4xl font-serif font-semibold align-baseline"
              href="/mainpage"
            >
              Medium
            </a>
          ...
          <div className=" inline-block align-bottom absolute right-2 sm:right-8">
            <div className="inline-block cursor-pointer text-400 text-[#6b6b6b] ">
              <SlNote className="inline-block align-center" size={25} />
              <button
                className="mr-4 sm:mr-8 ml-2 align-center font-serif cursor-pointer"
