    ...
    <>
      <div className="max-w-7xl h-full flex  mx-auto   grid grid-cols-1 md:grid-cols-2">
        <div className="text-[#242424] py-8 px-6">
          ...
          <div className="text-2xl text-400 text-[#242424] py-8">
            A Place to read, write, and deepen your understanding
          </div>
          <button
            className="rounded-full px-[20px] py-[8px] text-2xl text-white  bg-green-700 md:text-white md:bg-black cursor-pointer"
            onClick={onpenLogin}
          >
            Start reading
          </button>
        ...
        <div className="hidden md:contents relative">
          <img
            className="absolute right-0 truncate"
